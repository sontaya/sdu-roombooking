        ...
        init: function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
				...
				eventClick: function(info) {
					...
					var getTargetURL = BASE_URL + 'meetingbackoffice/get_booking_info/'+info.event.id;
				...
				eventSources: [
					{
						url: BASE_URL + 'meeting/view_approved_json',
						method: 'POST',
						extraParams: {
							room_id: targetRoom
						},
					...
					{
						url: BASE_URL + 'meeting/view_pending_json',
						method: 'POST',
						extraParams: {
							room_id: targetRoom
						},
					...
					{
						url: BASE_URL + 'meeting/view_other_approved_json',
						method: 'POST',
						extraParams: {
							room_id: targetRoom
						},
						...
						color: '#d1b8fd',   // a non-ajax option
