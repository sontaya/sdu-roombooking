        ...
        init: function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
				...
				eventClick: function(info) {
					...
					var getTargetURL = BASE_URL + 'dpbackoffice/get_booking_info/'+info.event.id;
				...
				eventSources: [
					{
						url: BASE_URL + 'dp/view_approved_json',
						method: 'POST',
						extraParams: {
							room_id: targetRoom
						},
					...
					{
						url: BASE_URL + 'dp/view_pending_json',
						method: 'POST',
						extraParams: {
							room_id: targetRoom
						},
					...
					{
						url: BASE_URL + 'dp/view_other_approved_json',
						method: 'POST',
						extraParams: {
							room_id: targetRoom
						},
