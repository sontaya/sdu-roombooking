...
class Linelogin {
    ...
    private const CLIENT_ID = '1655707326';
    private const CLIENT_SECRET = '0d1fa760ca14f3ae128db44e978d6ed8';
    ...
    private const REDIRECT_URL = 'https://roombooking.dusit.ac.th/lineapi/callback_login';
    ...
    function decode_token($id_token) {
        // $url = self::VERIFYTOKEN_URL . '?id_token=' . $id_token;
        // $response = $this->sendCURL($url, NULL, 'POST');
        // return $response;
        ...
        $response = $this->sendCURL(self::VERIFYTOKEN_URL, NULL, 'POST', $data);
		return $response;
    }
