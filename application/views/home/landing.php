						...
						<div class="container py-8">
										...
										<div class="card card-custom p-6 mb-8 mb-lg-0">
											<div class="card-body">
												<div class="row">
													<!--begin::Content-->
													<div class="col-sm-8">
														<h2 class="text-dark mb-4">Meeting Room</h2>
														<h5 class="text-dark-50">สำหรับใช้ในการจองห้องประชุม</h5>
													</div>
													<!--end::Content-->
													<!--begin::Button-->
													<div class="col-sm-4 d-flex align-items-center justify-content-sm-end">
														<a href="<?php echo base_url('page/set_active_template/MT') ?>" class="btn font-weight-bolder text-uppercase font-size-lg btn-teal py-3 px-6 ">เริ่มจองห้อง</a>
													</div>
													<!--end::Button-->
												</div>
												...
												<div class="row row-paddingless mb-4 mt-5">
													...
													<div class="col">
														<div class="d-flex align-items-center mr-2">
															...
															<!--begin::Title-->
															<div>
																<div class="font-size-h4 text-success font-weight-bolder"><?php echo $mt_summary[0]->count_approved; ?> รายการ</div>
																<div class="font-size-sm text-muted font-weight-bold mt-1">Success</div>
															</div>
															<!--end::Title-->
														</div>
													...
													<div class="col">
														<div class="d-flex align-items-center mr-2">
															...
															<!--begin::Title-->
															<div>
																<div class="font-size-h4 text-primary font-weight-bolder"><?php echo $mt_summary[0]->count_pending; ?> รายการ</div>
																<div class="font-size-sm text-muted font-weight-bold mt-1">Pending</div>
															</div>
															<!--end::Title-->
														</div>
													...
													<div class="col">
														<div class="d-flex align-items-center mr-2">
															...
															<!--begin::Title-->
															<div>
																<div class="font-size-h4 text-warning font-weight-bolder"><?php echo $mt_summary[0]->count_rejected; ?> รายการ</div>
																<div class="font-size-sm text-muted font-weight-bold mt-1">Rejected</div>
															</div>
															<!--end::Title-->
														</div>
							...
							<?php
								if (($this->session->userdata('auth')['role'] == "admin") || ($this->session->userdata('auth')['role'] == "delegate_admin") || (in_array("space", $this->session->userdata('auth')['manage_app']) )) {
							?>
									<div class="row mt-4">
											<div class="col-lg-6">
												<!--begin::Callout-->
												<div class="card card-custom p-6 mb-8 mb-lg-0">
													<div class="card-body">
														<div class="row">
															<!--begin::Content-->
															<div class="col-sm-8">
																<h2 class="text-dark mb-4">Activity Space</h2>
																<h5 class="text-dark-50">สำหรับใช้ในการจัดกิจกรรม</h5>
															</div>
															<!--end::Content-->
															<!--begin::Button-->
															<div class="col-sm-4 d-flex align-items-center justify-content-sm-end">
																<a href="<?php echo base_url('page/set_active_template/SP') ?>" class="btn font-weight-bolder text-uppercase font-size-lg btn-success py-3 px-6">เริ่มจองห้อง</a>
															</div>
															<!--end::Button-->
														</div>
							...
							<?
								...
								}elseif($this->session->userdata('auth')['staff_arit'] == "Y"){
							?>
									<div class="row mt-4">
											<div class="col-lg-6">
												<!--begin::Callout-->
