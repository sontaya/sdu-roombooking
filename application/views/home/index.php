									...
									<div class="card card-custom wave wave-animate-slow wave-success mb-8 mb-lg-0">
										<div class="card-body">
											<div class="d-flex align-items-center p-5">
												...
												<!--begin::Content-->
												<div class="d-flex flex-column">
													<a href="https://www.youtube.com/watch?v=EjjSCbExs1k" target="_blank" class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">วิธีการใช้งาน HUB500</a>
												</div>
												<!--end::Content-->
											</div>
										</div>
