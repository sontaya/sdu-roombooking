				...
				<!--begin::Entry-->
						...
						<div class="card card-custom gutter-b ">
							<div class="card-header">
								<h3 class="card-title">ฟอร์มบันทึกข้อมูลการจองห้องประชุม</h3>
							...
							?>
							<form class="form" id="FormBooking" action="<?php echo base_url('meeting/form_store'); ?>" method="post" accept-charset="utf-8">
								<div class="card-body">
										...
										<div class="col-lg-3">
											...
											<select class="form-control" id="usage_category" name="usage_category" data-error="#usage_category_Error">
												<option value="">กรุณาเลือกลักษณะการใช้งาน</option>
													...
													<option value="4" <?php if($val_usage_category == 4){echo "selected";} ?>>
														ประชุมออนไซต์
													</option>
													<option value="5" <?php if($val_usage_category == 5){echo "selected";} ?>>
														ประชุมออนไลน์
													</option>
								...
								<div class="card-footer">
									<div class="row">
										<div class="col-lg-6">
											<button type="submit" class="btn btn-teal mr-2">บันทึก</button>
