...
<html lang="en">
	...
	<head><base href="">
		...
		<link href="<?= base_url('assets/themes/metronic9/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css?v=7.0.3'); ?>" rel="stylesheet" type="text/css" />
		...
		<link href="<?= base_url('assets/themes/metronic9/assets/css/style.bundle.css?v=7.0.3'); ?>" rel="stylesheet" type="text/css" />
		<!--end::Global Theme Styles-->
		<!--begin::Layout Themes(used by all pages)-->
		<!--end::Layout Themes-->
		<link rel="shortcut icon" href="<?= base_url('assets/themes/metronic9/assets/media/logos/favicon.ico'); ?>" />
	</head>
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="header-fixed header-mobile-fixed page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile bg-primary header-mobile-fixed">
			<!--begin::Logo-->
			<a href="index.html">
				<img alt="Logo" src="<?= base_url('assets/themes/metronic9/assets/media/logos/logo-letter-9.png'); ?>" class="max-h-30px" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
							...
							<div class="container">
								...
								<div class="d-none d-lg-flex align-items-center mr-3">
									...
									<a href="index.html" class="mr-20">
										<img alt="Logo" src="<?= base_url('assets/themes/metronic9/assets/media/logos/logo-letter-9.png'); ?>" class="max-h-35px" />
									</a>
									<!--end::Logo-->
		...
		<ul class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4">
			...
			<li class="nav-item mb-2" data-toggle="tooltip" title="Layout Builder" data-placement="left">
				<a class="btn btn-sm btn-icon btn-bg-light btn-text-primary btn-hover-primary" href="https://keenthemes.com/metronic/preview/demo9/builder.html" target="_blank">
					<i class="flaticon2-gear"></i>
				</a>
			</li>
			<!--end::Item-->
		...
		<script src="<?= base_url('assets/themes/metronic9/assets/plugins/global/plugins.bundle.js?v=7.0.3'); ?>"></script>
		<script src="<?= base_url('assets/themes/metronic9/assets/plugins/custom/prismjs/prismjs.bundle.js?v=7.0.3'); ?>"></script>
		<script src="<?= base_url('assets/themes/metronic9/assets/js/scripts.bundle.js?v=7.0.3'); ?>"></script>
		<!--end::Global Theme Bundle-->
		<!--begin::Page Vendors(used by this page)-->
		<script src="<?= base_url('assets/themes/metronic9/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js?v=7.0.3'); ?>"></script>
		<!--end::Page Vendors-->
		<!--begin::Page Scripts(used by this page)-->
		<script src="<?= base_url('assets/themes/metronic9/assets/js/pages/widgets.js?v=7.0.3'); ?>"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>
