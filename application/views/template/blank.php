...
<html lang="en">
	...
	<head><base href="">
		...
		<link href="<?= base_url('assets/themes/metronic7/assets/css/style.bundle.css?v=7.0.3'); ?>" rel="stylesheet" type="text/css" />
		<!--end::Global Theme Styles-->
		<!--begin::Layout Themes(used by all pages)-->
		<!--end::Layout Themes-->
		<link rel="shortcut icon" href="<?= base_url('assets/themes/metronic7/assets/media/logos/favicon.ico'); ?>" />
	</head>
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="header-fixed header-mobile-fixed page-loading">
												...
												<div class="scroll scroll-push" data-scroll="true" data-height="250" data-mobile-height="200">
													...
													<div class="d-flex align-items-center justify-content-between p-8">
														...
														<a href="#" class="symbol symbol-70 flex-shrink-0">
															<img src="<?= base_url('assets/themes/metronic7/assets/media/stock-600x400/img-1.jpg'); ?>" title="" alt="" />
														</a>
													</div>
													<!--end::Item-->
													<!--begin::Separator-->
													...
													<div class="d-flex align-items-center justify-content-between p-8">
														...
														<a href="#" class="symbol symbol-70 flex-shrink-0">
															<img src="<?= base_url('assets/themes/metronic7/assets/media/stock-600x400/img-2.jpg'); ?>" title="" alt="" />
														</a>
													</div>
													<!--end::Item-->
													<!--begin::Separator-->
													...
													<div class="d-flex align-items-center justify-content-between p-8">
														...
														<a href="#" class="symbol symbol-70 flex-shrink-0">
															<img src="<?= base_url('assets/themes/metronic7/assets/media/stock-600x400/img-3.jpg'); ?>" title="" alt="" />
														</a>
													</div>
													<!--end::Item-->
													<!--begin::Separator-->
													...
													<div class="d-flex align-items-center justify-content-between p-8">
														...
														<a href="#" class="symbol symbol-70 flex-shrink-0">
															<img src="<?= base_url('assets/themes/metronic7/assets/media/stock-600x400/img-4.jpg'); ?>" title="" alt="" />
														</a>
													</div>
													<!--end::Item-->
												</div>
											...
											<div class="card-body pt-0">
												...
												<div class="d-flex align-items-center flex-wrap mb-10">
													...
													<div class="symbol symbol-50 symbol-light mr-5">
														<span class="symbol-label">
															<img src="<?= base_url('assets/themes/metronic7/assets/media/svg/misc/006-plurk.svg'); ?>" class="h-50 align-self-center" alt="" />
														</span>
													</div>
													<!--end::Symbol-->
													<!--begin::Text-->
												...
												<div class="d-flex align-items-center flex-wrap mb-10">
													...
													<div class="symbol symbol-50 symbol-light mr-5">
														<span class="symbol-label">
															<img src="<?= base_url('assets/themes/metronic7/assets/media/svg/misc/015-telegram.svg'); ?>" class="h-50 align-self-center" alt="" />
														</span>
													</div>
													<!--end::Symbol-->
													<!--begin::Text-->
												...
												<div class="d-flex align-items-center flex-wrap mb-10">
													...
													<div class="symbol symbol-50 symbol-light mr-5">
														<span class="symbol-label">
															<img src="<?= base_url('assets/themes/metronic7/assets/media/svg/misc/003-puzzle.svg'); ?>" class="h-50 align-self-center" alt="" />
														</span>
													</div>
													<!--end::Symbol-->
													<!--begin::Text-->
												...
												<div class="d-flex align-items-center flex-wrap mb-10">
													...
													<div class="symbol symbol-50 symbol-light mr-5">
														<span class="symbol-label">
															<img src="<?= base_url('assets/themes/metronic7/assets/media/svg/misc/005-bebo.svg'); ?>" class="h-50 align-self-center" alt="" />
														</span>
													</div>
													<!--end::Symbol-->
													<!--begin::Text-->
												...
												<div class="d-flex align-items-center flex-wrap">
													...
													<div class="symbol symbol-50 symbol-light mr-5">
														<span class="symbol-label">
															<img src="<?= base_url('assets/themes/metronic7/assets/media/svg/misc/014-kickstarter.svg'); ?>" class="h-50 align-self-center" alt="" />
														</span>
													</div>
													<!--end::Symbol-->
													<!--begin::Text-->
			...
			<div class="offcanvas-content">
				...
				<div class="offcanvas-wrapper mb-5 scroll-pull">
					...
					<div class="d-flex align-items-center justify-content-between py-8">
						...
						<a href="#" class="symbol symbol-70 flex-shrink-0">
							<img src="<?= base_url('assets/themes/metronic7/assets/media/stock-600x400/img-8.jpg'); ?>" title="" alt="" />
						</a>
					</div>
					<!--end::Item-->
				</div>
		...
		<script src="<?= base_url('assets/themes/metronic7/assets/js/pages/widgets.js?v=7.0.3'); ?>"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>
