...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed page-loading">
		<!--begin::Main-->
		<!--begin::Header Mobile-->
		<div id="kt_header_mobile" class="header-mobile bg-info header-mobile-fixed">
			<!--begin::Logo-->
							...
							<div class="container">
								...
								<div class="d-none d-lg-flex align-items-center mr-3">
									...
									<ul class="header-tabs nav align-self-end font-size-lg" role="tablist" id="main-desktop-menu">
										<!--begin::Item-->
										<li class="nav-item">
											<a href="<?php echo base_url("hybrid/home"); ?>" class="nav-link py-4 px-6 <?php if($this->session->userdata('menu')['active'] == '100'){ echo "active";} ?>" >Home</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="nav-item mr-3">
											<a href="<?php echo base_url("hybrid/room_info"); ?>" class="nav-link py-4 px-6 <?php if($this->session->userdata('menu')['active'] == '200'){ echo "active";} ?>" >รายละเอียดห้อง</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="nav-item mr-3">
								...
								<div class="topbar bg-info">
									...
									?>
											<div class="topbar-item">
												<a href="#" class="btn btn-secondary font-weight-bold mr-2">Hybrid Room</a>
											</div>
											<div class="topbar-item">
							...
							<div class="container">
								...
								<div class="header-navs header-navs-left" id="kt_header_navs">
									...
									<ul class="header-tabs p-5 p-lg-0 d-flex d-lg-none nav nav-bold nav-tabs" role="tablist">
										...
										<!--begin::Item-->
										<li class="nav-item mr-2">
											<a href="<?php echo base_url("hybrid/room_info"); ?>" class="nav-link btn btn-clean" >รายละเอียดห้อง</a>
										</li>
										<!--end::Item-->
										<!--begin::จองห้อง-->
										<?php
												...
												<div id="kt_header_menu_booking" class="header-menu header-menu-mobile header-menu-layout-default">
													...
													<ul class="menu-nav">
														...
														<li class="menu-item" aria-haspopup="true">
															<a href="<?php echo base_url('hybrid/form') ?>" class="menu-link ">
														...
														<li class="menu-item" aria-haspopup="true">
															<a href="<?php echo base_url('hybrid/list') ?>" class="menu-link ">
														...
														<li class="menu-item" aria-haspopup="true">
															<a href="<?php echo base_url('hybrid/view') ?>" class="menu-link ">
												...
												<div class="tab-pane py-5 p-lg-0 <?php if($this->session->userdata('menu')['active'] == '500'){ echo "show active";} ?>" id="kt_header_tab_bookingadmin">
													...
													<div id="kt_header_menu_bookingadmin" class="header-menu header-menu-mobile header-menu-layout-default">
														...
														<ul class="menu-nav">
															...
															<li class="menu-item" aria-haspopup="true">
																<a href="<?php echo base_url('hybridbackoffice/booking_manage') ?>" class="menu-link ">
																	<span class="menu-text">รายการจองห้อง</span>
																	<span class="menu-desc"></span>
																	<i class="menu-arrow"></i>
																</a>
															...
															<li class="menu-item" aria-haspopup="true">
																<a href="<?php echo base_url('hybridbackoffice/booking_calendar') ?>" class="menu-link ">
																	<span class="menu-text">มุมมองปฏิทิน</span>
																	<span class="menu-desc"></span>
																	<i class="menu-arrow"></i>
																</a>
															...
															<li class="menu-item" aria-haspopup="true">
																<a href="<?php echo base_url('hybridbackoffice/form_admin') ?>" class="menu-link ">
