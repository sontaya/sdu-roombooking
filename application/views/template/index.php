							...
							<div class="container">
								...
								<div class="d-none d-lg-flex align-items-center mr-3">
									...
									<ul class="header-tabs nav align-self-end font-size-lg" role="tablist" id="main-desktop-menu">
										<!--begin::Item-->
										<li class="nav-item">
											<a href="<?php echo base_url("page/home"); ?>" class="nav-link py-4 px-6 <?php if($this->session->userdata('menu')['active'] == '100'){ echo "active";} ?>" data-toggle="tab" data-target="#kt_header_tab_home" role="tab">Home</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
							...
							<div class="container">
								...
								<div class="header-navs header-navs-left" id="kt_header_navs">
									...
									<ul class="header-tabs p-5 p-lg-0 d-flex d-lg-none nav nav-bold nav-tabs" role="tablist">
										...
										<!--begin::Item-->
										<li class="nav-item mr-2">
											<a href="#" class="nav-link btn btn-clean" data-toggle="tab" data-target="#kt_header_tab_2" role="tab">รายละเอียดห้อง</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="nav-item mr-2">
										...
										<!--begin::Item-->
										<li class="nav-item mr-2">
											<a href="<?php echo base_url("page/contact_staff"); ?>" class="nav-link btn btn-clean" data-toggle="tab" data-target="#kt_header_tab_staff" role="tab">ติดต่อเจ้าหน้าที่</a>
										</li>
										<!--end::Item-->

										<!--begin::Item-->
										<li class="nav-item mr-2">
											<a href="#" class="nav-link btn btn-clean" data-toggle="tab" data-target="#kt_header_menu_admin" role="tab">สำหรับเจ้าหน้าที่</a>
										</li>
										<!--end::Item-->
									</ul>
									<!--begin::Tab Navs-->
