							...
							<div class="container">
								...
								<div class="d-none d-lg-flex align-items-center mr-3">
									...
									<ul class="header-tabs nav align-self-end font-size-lg" role="tablist" id="main-desktop-menu">
										<!--begin::Item-->
										<li class="nav-item">
											<a href="<?php echo base_url("dp/home"); ?>" class="nav-link py-4 px-6 <?php if($this->session->userdata('menu')['active'] == '100'){ echo "active";} ?>" >Home</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="nav-item mr-3">
											<a href="<?php echo base_url("dp/room_info"); ?>" class="nav-link py-4 px-6 <?php if($this->session->userdata('menu')['active'] == '200'){ echo "active";} ?>" >รายละเอียดห้อง</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="nav-item mr-3">
										...
										<div class="tab-pane py-5 p-lg-0 <?php if($this->session->userdata('menu')['active'] == '300'){ echo "show active";} ?>" id="kt_header_tab_booking">
											...
											<div id="kt_header_menu_booking" class="header-menu header-menu-mobile header-menu-layout-default">
												...
												<ul class="menu-nav">
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="<?php echo base_url('dp/list') ?>" class="menu-link ">
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="<?php echo base_url('dp/view') ?>" class="menu-link ">
