							...
							<div class="container">
								...
								<div class="d-none d-lg-flex align-items-center mr-3">
									...
									<ul class="header-tabs nav align-self-end font-size-lg" role="tablist" id="main-desktop-menu">
										<!--begin::Item-->
										<li class="nav-item">
											<a href="<?php echo base_url("space/home"); ?>" class="nav-link py-4 px-6 <?php if($this->session->userdata('menu')['active'] == '100'){ echo "active";} ?>" >Home</a>
										</li>
										<!--end::Item-->

										<!--begin::Item-->
										<li class="nav-item mr-3">
											<a href="#" class="nav-link py-4 px-6 <?php if($this->session->userdata('menu')['active'] == '300'){ echo "active";} ?>" data-toggle="tab" data-target="#kt_header_tab_booking" role="tab">สำหรับผู้ปฏิบัติงาน</a>
										</li>
										<!--end::Item-->
										<?php
										...
										?>
											...
											<li class="nav-item mr-2">
												<a href="#" class="nav-link py-4 px-6 <?php if($this->session->userdata('menu')['active'] == '500'){ echo "active";} ?>" data-toggle="tab" data-target="#kt_header_tab_admin" role="tab">สำหรับผู้ดูแลระบบ</a>
											</li>
											<!--end::Item-->
										<?php
											 	}
							...
							<div class="container">
								...
								<div class="header-navs header-navs-left" id="kt_header_navs">
									...
									<ul class="header-tabs p-5 p-lg-0 d-flex d-lg-none nav nav-bold nav-tabs" role="tablist">
										...
										?>
											<li class="nav-item mr-2">
												<a href="#" class="nav-link btn btn-clean" data-toggle="tab" data-target="#kt_header_tab_booking" role="tab">ผู้ปฏิบัติงาน</a>
											</li>
										<?php
											 }
										?>
										<!--end::ผู้ปฏิบัติงาน-->
										<!--begin::จองโดยผู้ดูแลระบบ-->
										<?php
											 if(($this->session->userdata('auth')['role'] == "admin") || ($this->session->userdata('auth')['role'] == "delegate_admin")){
												if (in_array("space", $this->session->userdata('auth')['manage_app'])) {
										?>
											<li class="nav-item mr-2">
												<a href="#" class="nav-link btn btn-clean" data-toggle="tab" data-target="#kt_header_tab_bookingadmin" role="tab">จองโดยผู้ดูแลระบบ</a>
											</li>
										<?php
											 	}
											 }
										?>
										<!--end::จองโดยผู้ดูแลระบบ-->
									</ul>
									<!--begin::Tab Navs-->
											...
											<div id="kt_header_menu_booking" class="header-menu header-menu-mobile header-menu-layout-default">
												...
												<ul class="menu-nav">
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="<?php echo base_url('space/list') ?>" class="menu-link ">
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="<?php echo base_url('space/view') ?>" class="menu-link ">
															<span class="menu-text">มุมมองปฏิทิน (สถานที่จัดกิจกรรม)</span>
															<span class="menu-desc"></span>
															<i class="menu-arrow"></i>
														</a>
													</li>
													<li class="menu-item" aria-haspopup="true">
														<a href="<?php echo base_url('space/view_event') ?>" class="menu-link ">
															<span class="menu-text">มุมมองปฏิทิน (กิจกรรม)</span>
															<span class="menu-desc"></span>
															<i class="menu-arrow"></i>
														</a>
													</li>
												...
												<div class="tab-pane p-5 p-lg-0 <?php if ($this->session->userdata('menu')['active'] == '500') {
													...
													<div id="kt_header_menu_admin" class="header-menu header-menu-mobile header-menu-layout-default">
														...
														<ul class="menu-nav">
															...
															<li class="menu-item" aria-haspopup="true">
																<a href="<?php echo base_url('spacebackoffice/booking_manage') ?>" class="menu-link ">
																	<span class="menu-text">รายการจองห้อง</span>
																	<span class="menu-desc"></span>
																	<i class="menu-arrow"></i>
																</a>
															...
															<li class="menu-item" aria-haspopup="true">
																<a href="<?php echo base_url('spacebackoffice/booking_calendar') ?>" class="menu-link ">
																	<span class="menu-text">มุมมองปฏิทิน (สถานที่จัดกิจกรรม)</span>
																	<span class="menu-desc"></span>
																	<i class="menu-arrow"></i>
																</a>
															...
															<li class="menu-item" aria-haspopup="true">
																<a href="<?php echo base_url('spacebackoffice/booking_calendar_event') ?>" class="menu-link ">
																	<span class="menu-text">มุมมองปฏิทิน (กิจกรรม)</span>
																	<span class="menu-desc"></span>
																	<i class="menu-arrow"></i>
																</a>
															...
															<li class="menu-item" aria-haspopup="true">
																<a href="<?php echo base_url('spacebackoffice/form_admin') ?>" class="menu-link ">
																	<span class="menu-text">จองโดยผู้ดูแลระบบ</span>
																	<span class="menu-desc"></span>
																	<i class="menu-arrow"></i>
																</a>
															</li>
