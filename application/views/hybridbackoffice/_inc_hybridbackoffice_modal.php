<div class="modal fade" id="bookingSearchModal" tabindex="-1" role="dialog" aria-labelledby="bookingSearchModal" aria-hidden="true">
				...
				<div class="modal-body">
					...
					<form class="form" id="FormBookingModal"  method="post" accept-charset="utf-8">
						...
						<div class="card-footer">
							<div class="form-group row">
								<div class="col-lg-12">
								<label for="">เหตุผลในการยกเลิก/ไม่อนุมัติ:  </label>
							...
							<div class="form-group row">
								<div class="col-lg-12">
									...
									<button type="button" id="md_button_cancel" class="btn btn-lg btn-default disabled mr-2">ยกเลิกโดยผู้จอง</button>
