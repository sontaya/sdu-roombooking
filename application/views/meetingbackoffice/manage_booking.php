						...
						<form id="FormSearch" class="form" role="form" method="post">
							...
							<div class="form-group row">
								<div class="col-lg-3 col-xl-4 mt-5 mt-lg-0 mt-4 ">
									...
									<button type="submit" id="bm_search_button" class="btn btn-teal mr-2">Search</button>
								</div>
							</div>
				...
				<div class="card-header flex-wrap border-0 pt-6 pb-0">
					...
					<div class="card-toolbar">
						...
						<div class="dropdown dropdown-inline mr-2">
							<button type="button" class="btn btn-light-teal font-weight-bolder dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										...
										<tr>
											...
											<th scope="col">
													<div class="checkbox-single mb-2">
														<label class="checkbox checkbox-primary checkbox-all">
											...
											<tr>
												...
												<td class="text-right">
													<?php
														...
														switch ($booking['usage_software']) {
															case 'DingTalk':
																$target_logo = "dingtalk.png";
																break;
															case 'Meet':
																$target_logo = "meet.png";
																break;
															case 'Team':
																$target_logo = "teams.png";
																break;
															case 'WebEx':
																$target_logo = "webex.png";
																break;
															case 'Zoom':
																$target_logo = "zoom.png";
																break;
															default:
																$target_logo = "";
													...
													<?php
														if($target_logo != ""){
													?>
															<img alt="meeting_logo" src="<?= base_url('assets/images/app_logo/').$target_logo; ?>" class="max-h-25px" />
													<?php
														}
													?>
													...
													<div class="dropdown dropdown-inline">
														...
														<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
															<ul class="navi flex-column navi-hover py-2">
																...
																<li class="navi-item">
																	<a href="<?php echo base_url('meetingbackoffice/form_admin/').$booking["id"]; ?>" data-id="<?= $booking["id"] ?>" class="navi-link booking-edit">
